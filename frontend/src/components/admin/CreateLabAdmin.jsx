...
const CreateLabAdmin = ({ onSuccess }) => {
  ...
  return (
    <div>
      <h2 className="mb-6 text-2xl font-bold text-slate-100">Create Lab Admin</h2>
      <div className="max-w-md rounded-lg bg-white p-6 text-gray-900 shadow-md [color-scheme:light]">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-800">Lab</label>
            <select
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div>
